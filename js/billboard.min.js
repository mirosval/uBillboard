...
a)},h);m=a;f.trigger("udsBillboardSlideDidChange",m);d.pauseOnVideo&&j[m].transition=="none"?k.hide():(c.stop&&(o=!1),o?g.animateCountdown(j[m].delay):k.hide(),(d.autoplay||o)&&!c.stop&&q.play())}},next:function(){var a=g.getNextSlideId();q.animateSlide(a)},prev:function(){var a=g.getPrevSlideId();q.animateSlide(a)},random:function(){q.animateSlide(Math.floor(Math.random()*j.length+1))},play:function(){if(typeof m!=="number"||m===null)m=0;s!==null&&s.nextSlideAnimation!==null&&clearTimeout(s.nextSlideAnimation);
...
handleEmbeddedContent:function(a){if(a.transition=="none"&&a.embeddecContentHandled!==!0){var c=b(">.uds-bb-slide-"+a.id+">*",i);c.is("object")&&(c.prepend("<param name='wmode' value='opaque' />"),b("embed",c).attr("wmode","opaque"));c.css({position:"absolute",top:parseInt(d.height,10)/2-c.attr("height")/2,left:parseInt(d.width,10)/2-c.attr("width")/2,margin:"auto"});a.embeddecContentHandled=!0}},playVideo:function(a){$slide=b(".uds-stage .uds-bb-slide-"+a.id,f);$iframe=b("iframe",$slide);for(a=0;a<
b("iframe").length;a++)b("iframe").eq(a).get(0)==$iframe.get(0)&&(window.frames[a].postMessage(JSON.stringify({event:"command",func:"playVideo",args:null,id:$iframe.attr("id")}),"*"),window.frames[a].postMessage(JSON.stringify({method:"play"}),"*"),b(window).on("message",function(a){a=a.originalEvent;a.origin=="http://www.youtube.com"&&(a=JSON.parse(a.data),a.event=="onStateChange"&&a.info.playerState==0&&q.play())}))},pauseVideo:function(a){$slide=b(".uds-stage .uds-bb-slide-"+a.id,f);$iframe=b("iframe",
$slide);for(a=0;a<b("iframe").length;a++)b("iframe").eq(a).get(0)==$iframe.get(0)&&(window.frames[a].postMessage(JSON.stringify({event:"command",func:"pauseVideo",args:null,id:$iframe.attr("id")}),"*"),window.frames[a].postMessage(JSON.stringify({method:"pause"}),"*"))},pos:function(a){return Math.abs(parseInt(a,10))+"px"},neg:function(a){return"-"+Math.abs(parseInt(a,10))+"px"}},u={none:{delay:b.noop},left:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),c=0;c<
a;c++)b(".uds-column-"+c,f).delay(c*(600/a))}},right:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),c=0;c<a;c++)b(".uds-column-"+c,f).delay(600-c*(600/a))}},top:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),c=0;c<a;c++)b(".uds-row-"+c,f).delay(c*(600/a))}},bottom:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),c=0;c<a;c++)b(".uds-row-"+c,f).delay(600-c*(600/a))}},center:{delay:function(){for(var a=
...
10)/parseInt(d.squareSize,10)),e=0,h=a-1,f=0,g=c-1,i=0,j=0,k=0;i<a*c;)b(".uds-square-"+(a*k+j)).delay(1E3*(i/(a*c))),k==f&&j<h?j++:j==h&&k<g?k++:k==g&&j>e?j--:(k--,k==f&&(j++,k++,e++,h--,f++,g--)),i++}},spiralOut:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),c=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),e=0,h=a-1,f=0,g=c-1,j=0,i=0,k=0;j<a*c;)b(".uds-square-"+(a*k+i)).delay(1E3-1E3*(j/(a*c))),k==f&&i<h?i++:i==h&&k<g?k++:k==g&&i>e?i--:(k--,k==f&&
(i++,k++,e++,h--,f++,g--)),j++}},chess:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),c=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),e=0;e<c;e++)for(var h=0;h<a;h++){var f=h%2==0&&e%2==0||h%2==1&&e%2==1?0:1;b(".uds-square-"+(h*c+e)).delay(200*f)}}},zigzagHorizontal:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),c=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),e=0;e<c;e++)for(var f=0;f<a;f++){var g=
(f*a+(f%2==0?e:c-e))/(a*a+c/2);b(".uds-square-"+(f*c+e)).delay(700*g)}}},zigzagVertical:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),c=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),e=0;e<c;e++)for(var f=0;f<a;f++){var g=(e*c+(e%2==0?f:a-f))/(c*c+a/2);b(".uds-square-"+(f*c+e)).delay(700*g)}}}},n={none:{duration:0,direction:"",setup:function(){l.hide()},perform:b.noop()},fade:{duration:1E3,direction:"",setup:function(){p.css({opacity:0})},perform:function(){u[this.direction].delay();
p.animate({opacity:1},{duration:500})}},crossFade:{duration:1E3,direction:"",setup:function(){p.css({opacity:0})},perform:function(){u[this.direction].delay();i.animate({opacity:0},{duration:1E3});p.animate({opacity:1},{duration:500})}},slide:{duration:700,direction:"right",setup:function(){b(".uds-bb-slides",f).css({overflow:"hidden"});i.css({top:"0px",left:"0px"});if(this.direction==="left")l.show().css({top:"0px",left:g.neg(d.width)});else if(this.direction==="top")l.show().css({top:g.neg(d.height),
left:"0px"});else if(this.direction==="bottom")l.show().css({top:g.pos(d.height),left:"0px"});else if(this.direction==="top")l.show().css({top:"0px",left:g.pos(d.width)});else if(this.direction==="zigzagHorizontal"){parseInt(d.squareSize,10);var a=parseInt(d.height,10);p.each(function(){b(this).css({opacity:0,top:parseInt(b(this).css("top"),10)-a+"px"})});u[this.direction].delay()}else if(this.direction==="zigzagVertical"){parseInt(d.squareSize,10);var c=parseInt(d.width,10);p.each(function(){b(this).css({opacity:0,
left:parseInt(b(this).css("left"),10)-c+"px"})});u[this.direction].delay()}else l.show().css({top:"0px",left:g.pos(d.width)})},perform:function(){var a={duration:700,easing:"easeInOutQuad"};if(this.direction==="left")i.animate({left:g.pos(d.width)},a),l.animate({left:"0px"},a);else if(this.direction==="top")i.animate({top:g.pos(d.height)},a),l.animate({top:"0px"},a);else if(this.direction==="bottom")i.animate({top:g.neg(d.height)},a),l.animate({top:"0px"},a);else if(this.direction==="top")i.animate({left:g.neg(d.width)},
a),l.animate({left:"0px"},a);else if(this.direction==="zigzagHorizontal"){parseInt(d.squareSize,10);var c=parseInt(d.height,10);p.each(function(){b(this).animate({opacity:1,top:parseInt(b(this).css("top"),10)+c+"px"},a)})}else if(this.direction==="zigzagVertical"){parseInt(d.squareSize,10);var e=parseInt(d.width,10);p.each(function(){b(this).animate({opacity:1,left:parseInt(b(this).css("left"),10)+e+"px"},a)})}else i.animate({left:g.neg(d.width)},a),l.animate({left:"0px"},a)}},scale:{duration:1100,
direction:"",setup:function(){var a,c;if(this.direction==="right")a=g.pos(parseInt(d.height,10)/2),c=g.pos(d.width);else if(this.direction==="left")a=g.pos(parseInt(d.height,10)/2),c="0px";else if(this.direction==="top")a="0px",c=g.pos(parseInt(d.width,10)/2);else if(this.direction==="bottom")a=g.pos(d.height),c=g.pos(parseInt(d.width,10)/2);else if(this.direction==="center")a=g.pos(parseInt(d.height,10)/2),c=g.pos(parseInt(d.width,10)/2);else{if(this.direction==="zigzagHorizontal"){var e=parseInt(d.squareSize,
10);p.each(function(){b(this).css({top:parseInt(b(this).css("top"),10)+e/2+"px",left:parseInt(b(this).css("left"),10)+e/2+"px",height:"0px"})})}else this.direction==="zigzagVertical"?(e=parseInt(d.squareSize,10),p.each(function(){b(this).css({top:parseInt(b(this).css("top"),10)+e/2+"px",left:parseInt(b(this).css("left"),10)+e/2+"px",width:"0px"})})):(e=parseInt(d.squareSize,10),p.each(function(){b(this).css({top:parseInt(b(this).css("top"),10)+e/2+"px",left:parseInt(b(this).css("left"),10)+e/2+"px",
width:"0px",height:"0px"})}));u[this.direction].delay();return}l.css({top:a,left:c,width:"1px",height:"1px"})},perform:function(){if(b.inArray(this.direction,["center","top","left","bottom","right"])>-1)l.animate({top:"0px",left:"0px",width:d.width,height:d.height},{duration:1E3,easing:"easeInOutQuad"});else{var a=parseInt(d.squareSize,10);p.each(function(c,d){b(this).animate({top:parseInt(b(d).css("top"),10)-a/2+"px",left:parseInt(b(d).css("left"),10)-a/2+"px",width:a+"px",height:a+"px"},500)})}}}},
A={width:"960px",height:"400px",squareSize:"80px",autoplay:!0,showControls:!0,showPause:!0,showPaginator:!0,showThumbnails:!0,showTimer:!0,removeSlidesWithBrokenImages:!0};return this.each(function(){b(this);if(q[d])return q[d].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof d==="object"||!d)return q.init.apply(this,[A,d]);else b.error("Method "+d+" does not exist on uBillboard")})}})(jQuery);