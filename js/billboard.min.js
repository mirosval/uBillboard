...
slides[c].image+")",top:height+"px"}).animate({top:"0px"},{duration:1E3,complete:e,easing:"easeOutExpo"})};animationScaleTop=function(b,c,e){$next.css({"background-image":"url("+slides[c].image+")","-webkit-transform":"scale(0)","-moz-transform":"scale(0)",transform:"scale(0)","-webkit-transform-origin":"50% 0%","-moz-transform-origin":"50% 0%","transform-origin":"50% 0%",opacity:0}).animate({opacity:1},{duration:1E3,complete:e,step:function(h,g){var f=(new Date).getTime();f=a.easing.swing(null,f-
g.startTime,0,1,g.options.duration);a(g.elem).css({opacity:f,transform:"scale("+f+")","-moz-transform":"scale("+f+")","-webkit-transform":"scale("+f+")"})}})};animationScaleCenter=function(b,c,e){$next.css({"background-image":"url("+slides[c].image+")","-webkit-transform":"scale(0)","-moz-transform":"scale(0)",transform:"scale(0)","-webkit-transform-origin":"50% 50%","-moz-transform-origin":"50% 50%","transform-origin":"50% 50%",opacity:0}).animate({opacity:1},{duration:1E3,complete:e,step:function(h,
g){var f=(new Date).getTime();f=a.easing.swing(null,f-g.startTime,0,1,g.options.duration);a(g.elem).css({opacity:f,transform:"scale("+f+")","-moz-transform":"scale("+f+")","-webkit-transform":"scale("+f+")"})}})};animationScaleBottom=function(b,c,e){$next.css({"background-image":"url("+slides[c].image+")","-webkit-transform":"scale(0)","-moz-transform":"scale(0)",transform:"scale(0)","-webkit-transform-origin":"50% 100%","-moz-transform-origin":"50% 100%","transform-origin":"50% 100%",opacity:0}).animate({opacity:1},
...
"transform-origin":"100% 50%",opacity:0}).animate({opacity:1},{duration:1E3,complete:e,step:function(h,g){var f=(new Date).getTime();f=a.easing.swing(null,f-g.startTime,0,1,g.options.duration);a(g.elem).css({opacity:f,transform:"scaleX("+f+")","-moz-transform":"scaleX("+f+")","-webkit-transform":"scaleX("+f+")"})}})};animationScaleLeft=function(b,c,e){$next.css({"background-image":"url("+slides[c].image+")","-webkit-transform":"scaleX(0)","-moz-transform":"scaleX(0)",transform:"scaleX(0)","-webkit-transform-origin":"0% 50%",
"-moz-transform-origin":"0% 50%","transform-origin":"0% 50%",opacity:0}).animate({opacity:1},{duration:1E3,complete:e,step:function(h,g){var f=(new Date).getTime();f=a.easing.swing(null,f-g.startTime,0,1,g.options.duration);a(g.elem).css({opacity:f,transform:"scaleX("+f+")","-moz-transform":"scaleX("+f+")","-webkit-transform":"scaleX("+f+")"})}})};animationSquaresRandom=function(b,c,e){$squares=a(".uds-square",$next);$squares.css({"background-image":"url("+slides[c].image+")",opacity:0});$squares.each(function(){a(this).stop().delay(Math.round(Math.random()*
