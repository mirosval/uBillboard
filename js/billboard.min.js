...
a.embeddecContentHandled!==!0){var d=b(">.uds-bb-slide-"+a.id+">*",m);d.is("object")&&(d.prepend("<param name='wmode' value='opaque' />"),b("embed",d).attr("wmode","opaque"));d.css({position:"absolute",top:parseInt(g.height,10)/2-d.attr("height")/2,left:parseInt(g.width,10)/2-d.attr("width")/2,margin:"auto"});a.embeddecContentHandled=!0}},playVideo:function(a){if(!(typeof window.postMessage!=="function"||typeof JSON==="undefined"))for(var a=b(".uds-stage .uds-bb-slide-"+a.id,h),a=b("iframe",a),d=
0;d<b("iframe").length;d++)b("iframe").eq(d).get(0)===a.get(0)&&(window.frames[d].postMessage(JSON.stringify({event:"command",func:"playVideo",args:null,id:a.attr("id")}),"*"),window.frames[d].postMessage(JSON.stringify({method:"play"}),"*"),b(window).on("message",function(a){a=a.originalEvent;a.origin==="http://www.youtube.com"&&(a=JSON.parse(a.data),a.event==="onStateChange"&&a.info.playerState===0&&v.play())}))},pauseVideo:function(a){if(!(typeof window.postMessage!=="function"||typeof JSON===
"undefined"))for(var a=b(".uds-stage .uds-bb-slide-"+a.id,h),a=b("iframe",a),d=0;d<b("iframe").length;d++)b("iframe").eq(d).get(0)===a.get(0)&&(window.frames[d].postMessage(JSON.stringify({event:"command",func:"pauseVideo",args:null,id:a.attr("id")}),"*"),window.frames[d].postMessage(JSON.stringify({method:"pause"}),"*"))},prepareKenBurns:function(a){if(!a.hasVideo){if(typeof a.kenBurnsImageCache==="undefined"){var d=b(".uds-bb-slide-"+a.id,h),c=new Image;a.kenBurnsImage=c;var e=b("<canvas>").css({position:"relative",
width:i||g.width,height:k||g.height}).attr({width:i||g.width,height:k||g.height}).appendTo(d).get(0);if(typeof e.getContext==="function"){var f=e.getContext("2d");a.kenBurnsCanvasCache=f;a.kenBurnsImageCache=!1;c.onLoad=function(){f.clearRect(0,0,i,k);f.drawImage(c,0,0)};c.src=a.bg.replace("-full.","-ken.")}else b(e).remove(),a.kenBurnsCanvasCache=!1,c.src=a.bg.replace("-full.","-ken."),b(c).addClass("uds-ken-burns"),d.css({overflow:"hidden"}).append(c),a.kenBurnsImageCache=b(".uds-bb-slide-"+a.id+
" img.uds-ken-burns",h),a.kenBurnsImageCache.css({position:"relative",display:"block","-ms-interpolation-mode":"bicubic"})}a.kenBurnsCanvasCache?a.kenBurnsCanvasStartingCSS={top:0,left:0,width:i,height:k}:a.kenBurnsImageCache.css({top:0,left:0,width:i,height:k})}},kenBurns:function(a){if(!(a.hasVideo||typeof a.kenBurnsImageCache==="undefined"&&typeof a.kenBurnsCanvasCache==="undefined"))if(a.kenBurnsCanvasCache){clearInterval(s.kenBurnsCanvasTimer);var b=new Date,c=f.kenBurnsCSS(!1);a.kenBurnsCanvasCache.clearRect(0,
0,i,k);a.kenBurnsCanvasCache.drawImage(a.kenBurnsImage,0,0,i,k);s.kenBurnsCanvasTimer=setInterval(function(){var e=((new Date).getTime()-b.getTime())/a.kenBurnsSpeed,g=a.kenBurnsCanvasStartingCSS;a.kenBurnsCanvasCache.clearRect(0,0,i,k);a.kenBurnsCanvasCache.drawImage(a.kenBurnsImage,(1-e)*g.left+e*c.left,(1-e)*g.top+e*c.top,(1-e)*g.width+e*c.width,(1-e)*g.height+e*c.height);if(e>=1)b=new Date,a.kenBurnsCanvasStartingCSS=c,c=f.kenBurnsCSS(!1,c)},20)}else c=f.kenBurnsCSS(!0),a.kenBurnsImageCache.eq(0).stop().animate(c,
{duration:a.kenBurnsSpeed,easing:"easeInOutQuad",complete:function(){a.id===o&&f.kenBurns(a,c)}})},kenBurnsCSS:function(a,b){function c(){var a=0;a+=Math.abs(e.scale-1);a+=Math.abs(e.top);a+=Math.abs(e.left);return a}var e,f,h;typeof b=="undefined"&&(b={top:0,left:0,width:i,height:k});do e={scale:1.2-Math.random()*0.4,top:-0.2+Math.random()*0.4,left:-0.2+Math.random()*0.4};while(c()<0.2);f={top:e.top*k,left:e.left*i,width:i*e.scale,height:k*e.scale};h=parseInt(g.height,10)/parseInt(g.width,10);if(f.top>
0)f.top=0;if(f.left>0)f.left=0;if(f.top+f.height<k)f.height=-f.top+k,f.width=f.height/h;if(f.left+f.width<i)f.width=-f.left+i,f.height=f.width*h;a&&(f.top+="px",f.left+="px",f.width+="px",f.height+="px");return f},isSlowBrowser:function(){return f.isMobile()||b.browser.msie&&b.browser.version<9},isMobile:function(){var a=navigator.userAgent,a={ios:b.isArray(a.match(/(iPhone|iPod|iPad)/)),blackberry:b.isArray(a.match(/BlackBerry/)),android:b.isArray(a.match(/Android/))};return a.ios||a.blackberry||
a.android?!0:!1},shouldUseRetina:function(){return typeof window.devicePixelRatio==="number"?window.devicePixelRatio>1:!1},maybeUseRetina:function(a,b){var c=typeof b.retina!=="undefined"?b.retina:!1;return f.shouldUseRetina()&&c?a.replace("-full.","-full-retina."):a},pos:function(a){return Math.abs(parseInt(a,10))+"px"},neg:function(a){return"-"+Math.abs(parseInt(a,10))+"px"}},y={none:{delay:b.noop},intuitive:{delay:b.noop},intuitiveVertical:{delay:b.noop},left:{delay:function(){for(var a=Math.ceil(parseInt(g.width,
10)/parseInt(g.squareSize,10)),d=0;d<a;d++)b(".uds-column-"+d,h).delay(d*(600/a))}},right:{delay:function(){for(var a=Math.ceil(parseInt(g.width,10)/parseInt(g.squareSize,10)),d=0;d<a;d++)b(".uds-column-"+d,h).delay(600-d*(600/a))}},top:{delay:function(){for(var a=Math.ceil(parseInt(g.height,10)/parseInt(g.squareSize,10)),d=0;d<a;d++)b(".uds-row-"+d,h).delay(d*(600/a))}},bottom:{delay:function(){for(var a=Math.ceil(parseInt(g.height,10)/parseInt(g.squareSize,10)),d=0;d<a;d++)b(".uds-row-"+d,h).delay(600-
