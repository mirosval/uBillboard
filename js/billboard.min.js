...
n+1;return typeof k[a]==="undefined"?0:a},getPrevSlideId:function(){var a=n-1;return typeof k[a]==="undefined"?k.length-1:a},createCountdown:function(){if(d.showTimer!==!1)i=c('<div class="uds-bb-countdown"></div>').appendTo(x),canvas=i.append('<canvas width="100" height="100">').find("canvas").get(0),canvas.getContext?(ctx=canvas.getContext("2d"),ctx.lineWidth=3,ctx.strokeStyle="white",ctx.shadowOffsetX=0,ctx.shadowOffsetY=0,ctx.shadowBlur=2,ctx.shadowColor="black",i.data("context",ctx)):(i.remove(),
i=null)},animateCountdown:function(a){if(!(i===null||typeof i==="undefined"||d.showTimer===!1)){var b=i.data("context"),c=0;if(a!==!1){var h=(new Date).getTime();i.data("start",h);i.data("duration",a);clearInterval(q.countDown);q.countDown=setInterval(function(){f.animateCountdown(!1)},30)}else c=(new Date).getTime()-i.data("start"),a=i.data("duration");c/a>=1&&clearInterval(q.countDown);b.clearRect(0,0,100,100);b.beginPath();b.arc(50,50,20,-Math.PI/2,-Math.PI/2+2*Math.PI*(c/a),!1);b.stroke()}},getSlideBackgroundCSS:function(a){return a.bg!==
""?{backgroundColor:a.bgColor,backgroundImage:"url("+a.bg+")",backgroundRepeat:a.repeat}:{backgroundColor:a.bgColor,backgroundImage:"",backgroundRepeat:a.repeat}},handleEmbeddedContent:function(a){if(a.transition=="none"&&(l.html(a.html),a.embeddecContentHandled!==!0)){var b=c(">*",l);b.is("object")&&(b.prepend("<param name='wmode' value='opaque' />"),c("embed",b).attr("wmode","opaque"));b.css({position:"absolute",top:parseInt(d.height,10)/2-b.attr("height")/2,left:parseInt(d.width,10)/2-b.attr("width")/
2,margin:"auto"});a.html=l.html();a.embeddecContentHandled=!0}},pos:function(a){return Math.abs(parseInt(a,10))+"px"},neg:function(a){return"-"+Math.abs(parseInt(a,10))+"px"}},r={none:{delay:c.noop},left:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),b=0;b<a;b++)c(".uds-column-"+b,g).delay(b*(600/a))}},right:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),b=0;b<a;b++)c(".uds-column-"+b,g).delay(600-b*(600/a))}},top:{delay:function(){for(var a=
Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),b=0;b<a;b++)c(".uds-row-"+b,g).delay(b*(600/a))}},bottom:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),b=0;b<a;b++)c(".uds-row-"+b,g).delay(600-b*(600/a))}},center:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),b=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),e=0;e<b;e++)for(var h=0;h<a;h++){var f=Math.sqrt(Math.pow(e-b/2+0.5,2)+Math.pow(h-a/2+0.5,
2))/Math.sqrt(Math.pow(b/2,2)+Math.pow(a/2,2));c(".uds-square-"+(h*b+e)).delay(700*f)}}},randomSquares:{delay:function(){m.each(function(){c(this).delay(Math.random()*700)})}},spiralIn:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),b=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),e=0,h=a-1,f=0,g=b-1,k=0,j=0,i=0;k<a*b;)c(".uds-square-"+(a*i+j)).delay(1E3*(k/(a*b))),i==f&&j<h?j++:j==h&&i<g?i++:i==g&&j>e?j--:(i--,i==f&&(j++,i++,e++,h--,f++,g--)),k++}},
spiralOut:{delay:function(){for(var a=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),b=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),e=0,h=a-1,f=0,g=b-1,k=0,j=0,i=0;k<a*b;)c(".uds-square-"+(a*i+j)).delay(1E3-1E3*(k/(a*b))),i==f&&j<h?j++:j==h&&i<g?i++:i==g&&j>e?j--:(i--,i==f&&(j++,i++,e++,h--,f++,g--)),k++}},chess:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),b=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),e=0;e<b;e++)for(var h=
0;h<a;h++){var f=h%2==0&&e%2==0||h%2==1&&e%2==1?0:1;c(".uds-square-"+(h*b+e)).delay(200*f)}}},zigzagHorizontal:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),b=Math.ceil(parseInt(d.width,10)/parseInt(d.squareSize,10)),e=0;e<b;e++)for(var h=0;h<a;h++){var f=(h*a+(h%2==0?e:b-e))/(a*a+b/2);c(".uds-square-"+(h*b+e)).delay(700*f)}}},zigzagVertical:{delay:function(){for(var a=Math.ceil(parseInt(d.height,10)/parseInt(d.squareSize,10)),b=Math.ceil(parseInt(d.width,
10)/parseInt(d.squareSize,10)),e=0;e<b;e++)for(var f=0;f<a;f++){var g=(e*b+(e%2==0?f:a-f))/(b*b+a/2);c(".uds-square-"+(f*b+e)).delay(700*g)}}}},o={none:{duration:0,direction:"",setup:function(){j.hide()},perform:c.noop()},fade:{duration:1E3,direction:"",setup:function(){m.css({opacity:0})},perform:function(){r[this.direction].delay();m.animate({opacity:1},{duration:500})}},crossFade:{duration:1E3,direction:"",setup:function(){m.css({opacity:0})},perform:function(){r[this.direction].delay();l.animate({opacity:0},
{duration:1E3});m.animate({opacity:1},{duration:500})}},slide:{duration:700,direction:"right",setup:function(){c(".uds-bb-slides",g).css({overflow:"hidden"});l.css({top:"0px",left:"0px"});if(this.direction==="left")j.show().css({top:"0px",left:f.neg(d.width)});else if(this.direction==="top")j.show().css({top:f.neg(d.height),left:"0px"});else if(this.direction==="bottom")j.show().css({top:f.pos(d.height),left:"0px"});else if(this.direction==="top")j.show().css({top:"0px",left:f.pos(d.width)});else if(this.direction===
"zigzagHorizontal"){parseInt(d.squareSize,10);var a=parseInt(d.height,10);m.each(function(){c(this).css({opacity:0,top:parseInt(c(this).css("top"),10)-a+"px"})});r[this.direction].delay()}else if(this.direction==="zigzagVertical"){parseInt(d.squareSize,10);var b=parseInt(d.width,10);m.each(function(){c(this).css({opacity:0,left:parseInt(c(this).css("left"),10)-b+"px"})});r[this.direction].delay()}else j.show().css({top:"0px",left:f.pos(d.width)})},perform:function(){var a={duration:700,easing:"easeInOutQuad"};
if(this.direction==="left")l.animate({left:f.pos(d.width)},a),j.animate({left:"0px"},a);else if(this.direction==="top")l.animate({top:f.pos(d.height)},a),j.animate({top:"0px"},a);else if(this.direction==="bottom")l.animate({top:f.neg(d.height)},a),j.animate({top:"0px"},a);else if(this.direction==="top")l.animate({left:f.neg(d.width)},a),j.animate({left:"0px"},a);else if(this.direction==="zigzagHorizontal"){parseInt(d.squareSize,10);var b=parseInt(d.height,10);m.each(function(){c(this).animate({opacity:1,
top:parseInt(c(this).css("top"),10)+b+"px"},a)})}else if(this.direction==="zigzagVertical"){parseInt(d.squareSize,10);var e=parseInt(d.width,10);m.each(function(){c(this).animate({opacity:1,left:parseInt(c(this).css("left"),10)+e+"px"},a)})}else l.animate({left:f.neg(d.width)},a),j.animate({left:"0px"},a)}},scale:{duration:1100,direction:"",setup:function(){var a,b;if(this.direction==="right")a=f.pos(parseInt(d.height,10)/2),b=f.pos(d.width);else if(this.direction==="left")a=f.pos(parseInt(d.height,
10)/2),b="0px";else if(this.direction==="top")a="0px",b=f.pos(parseInt(d.width,10)/2);else if(this.direction==="bottom")a=f.pos(d.height),b=f.pos(parseInt(d.width,10)/2);else if(this.direction==="center")a=f.pos(parseInt(d.height,10)/2),b=f.pos(parseInt(d.width,10)/2);else{if(this.direction==="zigzagHorizontal"){var e=parseInt(d.squareSize,10);m.each(function(){c(this).css({top:parseInt(c(this).css("top"),10)+e/2+"px",left:parseInt(c(this).css("left"),10)+e/2+"px",height:"0px"})})}else this.direction===
"zigzagVertical"?(e=parseInt(d.squareSize,10),m.each(function(){c(this).css({top:parseInt(c(this).css("top"),10)+e/2+"px",left:parseInt(c(this).css("left"),10)+e/2+"px",width:"0px"})})):(e=parseInt(d.squareSize,10),m.each(function(){c(this).css({top:parseInt(c(this).css("top"),10)+e/2+"px",left:parseInt(c(this).css("left"),10)+e/2+"px",width:"0px",height:"0px"})}));r[this.direction].delay();return}j.css({top:a,left:b,width:"1px",height:"1px"})},perform:function(){if(c.inArray(this.direction,["center",
"top","left","bottom","right"])>-1)j.animate({top:"0px",left:"0px",width:d.width,height:d.height},{duration:1E3,easing:"easeInOutQuad"});else{var a=parseInt(d.squareSize,10);m.each(function(b,d){c(this).animate({top:parseInt(c(d).css("top"),10)-a/2+"px",left:parseInt(c(d).css("left"),10)-a/2+"px",width:a+"px",height:a+"px"},500)})}}}},B={width:"960px",height:"400px",squareSize:"80px",autoplay:!0,showControls:!0,showPause:!0,showPaginator:!0,showThumbnails:!0,showTimer:!0,removeSlidesWithBrokenImages:!0};
return this.each(function(){c(this);if(s[d])return s[d].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof d==="object"||!d)return s.init.apply(this,[B,d]);else c.error("Method "+d+" does not exist on uBillboard")})}})(jQuery);