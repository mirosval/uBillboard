...
typeof i!=="undefined"&&i.hide()},playpause:function(){s?r.pause():r.play()}},f={initSlides:function(){h=[];c(".uds-bb-slide",g).each(function(a,b){var d={delay:parseInt(c(".uds-delay",b).remove().text(),10),transition:c(".uds-transition",b).remove().text(),direction:c(".uds-direction",b).remove().text(),bgColor:c(".uds-background",b).remove().text(),bg:c(".uds-bb-bg-image",b).remove().attr("src"),link:c(".uds-bb-link",b).remove().attr("href"),html:c(b).remove().html()};h.push(d)})},initPreloader:function(){g.append('<div class="uds-bb-preloader-wrapper"><div class="uds-bb-preloader"><div class="uds-bb-preloader-indicator"></div></div></div>');
