...
b(this).outerHeight()/2;b(this).css({top:k/2-a})});b(".uds-center-horizontal",h).each(function(){var a=b(this).outerWidth()/2;b(this).css({left:i/2-a})});for(a=0;a<l.length;a++)if(l[a].hasVideo)for(var c=b(".uds-bb-slide-"+a+">*",h),d=0;d<c.length;d++){var e=c.eq(d),f=b(e).attr("width")/b(e).attr("height"),n=b(e).attr("width"),o=b(e).attr("height");b(e).attr("height")>k?(o=k,n=o*f):b(e).attr("width")>i&&(n=i,o=n/f);e.css({position:"absolute",top:k/2-o/2,left:i/2-n/2,width:n,height:o,margin:"auto"})}b(".uds-bb-slide>canvas").each(function(){b(this).css({width:i,
height:k}).attr({width:i,height:k})});b(".uds-bb-slide>.uds-bb-description").each(function(){var a=b(this),c=["top","bottom","height","right","left","width"],d=["font-size","margin-left","margin-top","margin-right","margin-bottom"],e={},f=k/parseInt(g.height,10),n=i/parseInt(g.width,10);typeof a.data("original-position")==="undefined"&&(a.data("original-position",!0),b.each(c,function(c,b){a.data(b,parseInt(a.css(b),10))}),b("h1,h2,h3,h4,h5,h6,p,div,span,ul,ol,li,a",a).each(function(){var a=b(this);
...
f={initSlides:function(){var a={delay:5E3,hasVideo:!1,linkTarget:"",transition:"fade",direction:"",bg:"",bgColor:"transparent",repeat:"no-repeat",link:"",stop:!1,autoplayVideo:!0,kenBurns:!1,kenBurnsSpeed:4E3,retina:!1,html:""};l=[];b(".uds-bb-slide",h).each(function(d,c){var e=f.maybeUseRetina(b(".uds-bb-bg-image",c).remove().attr("src"),g.slides[d]),e=b.extend({},a,g.slides[d],{id:d,bg:e,link:b(".uds-bb-link",c).remove().attr("href"),html:b(c).remove().html()}),n=b("<div class='uds-bb-slide-"+d+
" uds-bb-slide'>");n.css({display:"none",maxWidth:g.width,maxHeight:g.height,width:"100%",height:"100%"}).css(f.getSlideBackgroundCSS(e)).html(e.html);e.cache=n;l.push(e)})},preloadRequired:function(){var a=!0;b(".uds-bb-bg-image",h).each(function(){var d=b(this).get(0);a=a&&d.complete});return!a},initPreloader:function(){h.append('<div class="uds-bb-preloader-wrapper"><div class="uds-bb-preloader"><div class="uds-bb-preloader-indicator"></div></div></div>');C=b(".uds-bb-preloader-wrapper",h);var a=
...
height:d,top:-(i*c),left:-(l*c),opacity:1}).stop(!0,!0);m.css({opacity:1}).add(j).css({top:"0px",left:"0px"})},prepareForAnimation:function(a){var d=l[o],c=l[a];typeof d==="undefined"||d===null?B("Slide "+o+" does not exist! (Current Slide)"):typeof c==="undefined"||c===null?B("Slide "+a+" does not exist! (Next Slide)"):(b(".uds-bb-slide",m).fastHide(),b(".uds-bb-slide-"+d.id,m).fastShow(),b(".uds-bb-description",m).fastShow(),f.resetAnimation(),clearInterval(s.kenBurnsCanvasTimer),c.kenBurns&&f.prepareKenBurns(c),
...
perform:b.noop()},fade:{duration:1500,direction:"",setup:function(){(f.isSlowBrowser()?j:r).css({opacity:0})},perform:function(){var a=f.isSlowBrowser()?j:r;y[this.direction].delay();a.animate({opacity:1},{duration:500})}},crossFade:{duration:1E3,direction:"",setup:function(){(f.isSlowBrowser()?j:r).css({opacity:0})},perform:function(){y[this.direction].delay();m.animate({opacity:0},{duration:1E3});(f.isSlowBrowser()?j:r).animate({opacity:1},{duration:500})}},slide:{duration:700,direction:"right",
setup:function(a,d){b(".uds-bb-slides",h).css({overflow:"hidden"});m.css({top:"0px",left:"0px"});var c=this.direction;if(c==="intuitive"||c==="intuitiveVertical")c=(a<d||d===0&&a===l.length-1)&&!(d===l.length-1&&a===0)?c==="intuitive"?"right":"top":c==="intuitive"?"left":"bottom";c==="left"?j.fastShow().css({top:"0px",left:f.neg(i)}):c==="top"?j.fastShow().css({top:f.neg(k),left:"0px"}):c==="bottom"?j.fastShow().css({top:f.pos(k),left:"0px"}):c==="top"?j.fastShow().css({top:"0px",left:f.pos(i)}):
c==="zigzagHorizontal"?(parseInt(g.squareSize,10),r.each(function(){b(this).css({opacity:0,top:parseInt(b(this).css("top"),10)-k+"px"})}),y[c].delay()):this.direction==="zigzagVertical"?(parseInt(g.squareSize,10),r.each(function(){b(this).css({opacity:0,left:parseInt(b(this).css("left"),10)-i+"px"})}),y[c].delay()):j.fastShow().css({top:"0px",left:f.pos(i)})},perform:function(a,d){var c={duration:700,easing:"easeInOutQuad"},e=this.direction;if(e==="intuitive"||e==="intuitiveVertical")e=(a<d||d===
0&&a===l.length-1)&&!(d===l.length-1&&a===0)?e==="intuitive"?"right":"top":e==="intuitive"?"left":"bottom";e==="left"?(m.animate({left:f.pos(i)},c),j.animate({left:"0px"},c)):e==="top"?(m.animate({top:f.pos(k)},c),j.animate({top:"0px"},c)):e==="bottom"?(m.animate({top:f.neg(k)},c),j.animate({top:"0px"},c)):e==="top"?(m.animate({left:f.neg(i)},c),j.animate({left:"0px"},c)):e==="zigzagHorizontal"?(parseInt(g.squareSize,10),r.each(function(){b(this).animate({opacity:1,top:parseInt(b(this).css("top"),
